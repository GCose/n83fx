  ...
  return (
    <section className="flex min-h-screen pt-[5rem] flex-col bg-n83-white">
      <div className="flex-1 w-full flex flex-col px-container py-[clamp(4rem,6vw,6rem)]">
        ...
        <div className="border-t border-b border-n83-black py-[clamp(4rem,5vw,5rem)]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-[clamp(3rem,4vw,4rem)] text-center">
            <div>
              <h3 className="m-0 font-extrabold leading-[1.2] text-n83-black text-[clamp(3rem,4vw,4rem)] mb-[clamp(1rem,1.5vw,1.5rem)]">
                MT5
              </h3>
              <p className="m-0 font-normal leading-[1.4] text-n83-gray-600 text-[clamp(1.4rem,1.6vw,1.7rem)]">
                Platform
              </p>
            </div>
            <div>
