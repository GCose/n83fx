          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[clamp(3rem,4vw,4rem)] mb-[clamp(6rem,8vw,8rem)]">
            {steps.map((step, index) => (
              <div key={index} className="text-center">
                <div className="w-[clamp(6rem,8vw,8rem)] h-[clamp(6rem,8vw,8rem)] bg-n83-white text-n83-text rounded-full flex items-center justify-center mx-auto mb-[clamp(2rem,3vw,3rem)] font-bold text-[clamp(2rem,2.5vw,2.5rem)]">
                  {step.number}
                </div>
