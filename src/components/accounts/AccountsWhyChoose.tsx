        ...
        <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-start">
          ...
          <div className="flex flex-col justify-center order-2 lg:order-1">
            ...
            <div className="space-y-[clamp(2.5rem,3vw,3rem)]">
              ...
              {/*==================== Editorial Quote ====================*/}
              <div className="pt-[clamp(2rem,3vw,3rem)] border-t border-n83-white">
          ...
          <div className="relative order-1 lg:order-2">
            ...
            {/*==================== Platform Features ====================*/}
            <div className="mt-[clamp(3rem,4vw,4rem)] border-t border-n83-white border-b grid grid-cols-1 gap-[clamp(1.5rem,2vw,2rem)]">
              <div className="p-[clamp(2rem,3vw,3rem)] text-center">
                <h4 className="m-0 font-bold leading-[1.2] text-n83-white text-[clamp(1.8rem,2vw,2rem)] mb-[0.5rem]">
                  MetaTrader 5
                </h4>
                <p className="m-0 font-normal leading-[1.3] text-white/70 text-[clamp(1.4rem,1.6vw,1.6rem)]">
