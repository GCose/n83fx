    ...
    <section className="bg-n83-white py-[clamp(8rem,10vw,12rem)]">
      <div className="w-full max-w-container mx-auto px-container">
        ...
        <div className="text-center mb-[clamp(6rem,7vw,8rem)]">
          ...
          <p className="m-0 font-normal leading-[1.4] text-white/70 text-[clamp(1.6rem,1.8vw,1.9rem)] max-w-[70rem] mx-auto">
          ...
          {accounts.map((account, index) => (
            ...
            >
              ...
              <div className="text-center mb-[clamp(2rem,2.5vw,6rem)]">
                <h3 className="m-0 font-bold leading-[1.2] text-n83-white text-[clamp(1.8rem,2vw,2rem)] mb-[clamp(0.5rem,1vw,1rem)] uppercase">
                  {account.title}
                </h3>
                <p className="m-0 font-normal leading-[1.3] text-white/70 text-[clamp(1.4rem,1.6vw,1.7rem)]">
                  {account.subtitle}
                </p>
              </div>
              ...
              <div className="space-y-[clamp(1.5rem,2vw,4rem)] my-[clamp(2.5rem,3vw,3rem)]">
                <div className="flex justify-between items-center border-b border-n83-gray pb-[clamp(1rem,1.5vw,1.5rem)]">
                  <span className="font-normal text-white/70 text-[clamp(1.4rem,1.6vw,1.7rem)]">
                    Min deposit
                  </span>
                  <span className="font-bold text-n83-white text-[clamp(1.4rem,1.6vw,1.7rem)]">
                    {account.minDeposit}
                  </span>
                </div>
                <div className="flex justify-between items-center border-b border-n83-gray pb-[clamp(1rem,1.5vw,1.5rem)]">
              ...
              {/*==================== Best For ====================*/}
              <div className="bg-n83-white border-l border-r  p-[clamp(2rem,2.5vw,2.5rem)] mb-[clamp(2.5rem,3vw,3rem)]">
                <p className="m-0 font-normal leading-[1.3] text-n83-white text-[clamp(1.4rem,1.6vw,1.7rem)] text-center">
