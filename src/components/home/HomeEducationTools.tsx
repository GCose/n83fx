        ...
        <div className="grid md:grid-cols-2 gap-[clamp(4rem,6vw,6rem)] mb-[clamp(6rem,8vw,8rem)]">
          {educationTools.map((tool, index) => (
            <div key={index} className="group">
              ...
              {/*==================== Tool Content ====================*/}
              <div>
                <h3 className="m-0 font-bold leading-[1.2] text-n83-white text-[clamp(1.8rem,2vw,2.1rem)] mb-[clamp(1.5rem,2vw,2rem)]">
                  {tool.title}
                </h3>
                <p className="m-0 font-normal leading-[1.4] text-white/70 text-[clamp(1.7rem,1.8vw,2rem)]">
                  {tool.description}
                </p>
              </div>
              {/*==================== End of Tool Content ====================*/}
