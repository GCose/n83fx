      ...
      <div className="w-full max-w-container mx-auto px-container">
        ...
        <div className="max-w-[90rem] mx-auto">
          <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-start">
            {/*==================== Left: Statement ====================*/}
            <div>
              <p className="m-0 font-normal leading-[1.5] text-white/70 text-[clamp(1.8rem,2vw,2.4rem)] mb-[clamp(3rem,4vw,4rem)]">
          ...
          <div className="mt-[clamp(6rem,8vw,8rem)]">
            <div className="bg-n83-gray-100 border-l border-r  p-[clamp(3rem,4vw,4rem)] text-center">
