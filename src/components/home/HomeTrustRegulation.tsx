      ...
      <div className="w-full max-w-container mx-auto px-container">
        ...
        <div className="mb-[clamp(8rem,10vw,10rem)]">
          ...
          <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-start">
            ...
            {/*==================== Right: Key Policies ====================*/}
            <div className="bg-n83-white rounded-[2rem] p-[clamp(3rem,4vw,4rem)]">
              <h4 className="m-0 font-bold leading-[1.2] text-n83-white text-[clamp(1.8rem,2vw,2rem)] mb-[clamp(2rem,2.5vw,2.5rem)]">
                Key Policies:
              </h4>
        ...
        <div>
          ...
          {/*==================== Expectations List ====================*/}
          <div className="bg-n83-white border-l border-r  p-[clamp(4rem,5vw,5rem)] max-w-[80rem] mx-auto">
