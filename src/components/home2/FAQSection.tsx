        ...
        <div className="relative z-10 w-full max-w-container mx-auto px-container">
          ...
          <div className="m-auto max-w-[100rem] space-y-[clamp(2rem,3vw,3rem)]">
            {faqs.map((faq, index) => (
              ...
              >
                {/*==================== Question ====================*/}
                <div className="bg-n83-black/40 backdrop-blur-md border border-text-tertiary/30 p-[clamp(2.5rem,3vw,3rem)] group-hover:border-neon-primary/60 transition-all duration-500">
