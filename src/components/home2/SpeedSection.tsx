    ...
    <>
      ...
      <section className="relative py-[clamp(10rem,20vw,15rem)] border-t">
        ...
        <div className="relative z-10 w-full max-w-container mx-auto px-container">
          {/*==================== Section Header ====================*/}
          <div className="mb-[clamp(8rem,12vw,10rem)] border-b pb-[clamp(3rem,4vw,4rem)]">
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="flex items-start gap-[clamp(3rem,4vw,4rem)]">
                    ...
                    {/*==================== Feature Content ====================*/}
                    <div className="bg-n83-black/40 backdrop-blur-md border-b p-[clamp(3rem,4vw,4rem)] group-hover:border-neon-primary/60 transition-all duration-500">
