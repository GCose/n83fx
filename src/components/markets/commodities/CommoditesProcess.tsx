...
const CommoditiesProcess = () => {
  const steps = [
    {
      number: "01",
      title: "Open Your Account",
      description:
        "Select the account type that fits your trading style — Standard, Advanced, Pro, or Islamic.",
    },
    {
      number: "02",
      title: "Fund Safely",
      description:
        "Deposit securely, with client funds held in segregated accounts.",
    },
    {
      number: "03",
      title: "Download MT5",
      description:
        "Trade from desktop, web, or mobile — all customized for clarity.",
    },
    {
      number: "04",
      title: "Choose Your Market",
      description: "Select from energy, metals, or agricultural commodities.",
    },
    {
      number: "05",
      title: "Execute with Clarity",
      description:
        "Place trades using straightforward tools, risk management features, and transparent pricing.",
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-center">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="m-0 font-extrabold leading-[1.2] text-n83-white text-[clamp(3rem,4vw,4.5rem)] mb-[clamp(3rem,4vw,4rem)] uppercase tracking-tight">
              How to Trade Commodities with N83-FX
            </h2>
            ...
            <div className="space-y-[clamp(2.5rem,3vw,3rem)] mb-[clamp(4rem,5vw,5rem)]">
              <p className="m-0 font-normal leading-[1.5] text-white/70 text-[clamp(1.6rem,1.8vw,1.9rem)]">
                Getting started with commodities trading at N83-FX is
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/commodities/commodities-process.jpg"
                alt="Step-by-step commodities trading account setup process"
...
export default CommoditiesProcess;
