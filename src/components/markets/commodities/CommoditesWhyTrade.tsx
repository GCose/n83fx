...
const CommoditiesWhyTrade = () => {
  const advantages = [
    {
      title: "Clarity in pricing",
      description: "No hidden fees, no overcomplicated contracts.",
    },
    {
      title: "Access to global markets",
      description: "Trade the world's most traded commodities directly on MT5.",
    },
    {
      title: "Diversification made simple",
      description:
        "Add commodities to your trading strategy to balance risk across markets.",
    },
    {
      title: "Respect for your capital",
      description: "Segregated accounts and transparent execution conditions.",
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-center">
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/commodities/commodities-whytradewithus.jpg"
                alt="N83-FX commodities trading advantages and platform benefits"
          ...
          <div className="flex flex-col justify-center">
            <h2 className="m-0 font-extrabold leading-[1.2] text-n83-black text-[clamp(3rem,4vw,4.5rem)] mb-[clamp(3rem,4vw,4rem)] uppercase tracking-tight">
              Why Trade Commodities with N83-FX?
            </h2>
            ...
            <div className="space-y-[clamp(2.5rem,3vw,3rem)]">
              <p className="m-0 font-normal leading-[1.5] text-n83-gray-600 text-[clamp(1.6rem,1.8vw,1.9rem)]">
                Most brokers treat commodities as an afterthought. At N83-FX, we
              ...
              <div className="pt-[clamp(2rem,3vw,3rem)] border-t border-n83-black">
                <p className="m-0 font-medium leading-[1.5] text-n83-black text-[clamp(1.7rem,1.9vw,2rem)]">
                  Trading commodities with us means focusing on decisions, not
                  distractions.
                </p>
              </div>
...
export default CommoditiesWhyTrade;
