...
const CommoditiesRisk = () => {
  const riskPrinciples = [
    "Use stop-loss and limit orders",
    "Diversify across commodities and other asset classes",
    "Stay informed with economic calendars and market updates",
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/commodities/commodities-risk.jpg"
                alt="Risk management tools and responsible commodities trading strategies"
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-[clamp(2.5rem,3vw,3rem)]">
              <p className="m-0 font-normal leading-[1.5] text-n83-gray-600 text-[clamp(1.6rem,1.8vw,1.9rem)]">
                Commodities can be volatile. Oil can spike on geopolitical
                events, and agricultural prices can swing with weather. At
                N83-FX, we encourage responsible risk management:
              </p>
              ...
              <div className="pt-[clamp(2rem,3vw,3rem)] border-t border-n83-black">
                <p className="m-0 font-medium leading-[1.5] text-n83-black text-[clamp(1.7rem,1.9vw,2rem)]">
                  We believe risk should always be clear, never hidden.
                </p>
              </div>
              ...
              <div className="p-[clamp(2.5rem,3vw,3rem)] bg-n83-white border-l border-r border-n83-black">
                <p className="m-0 font-medium leading-[1.4] text-n83-black text-[clamp(1.8rem,2vw,2rem)]">
                  At N83-FX, responsible risk management is built into every
                  trading tool and educational resource.
                </p>
              </div>
...
export default CommoditiesRisk;
