          ...
          <div className="flex flex-col justify-center">
            <div className="mb-[clamp(3rem,4vw,4rem)]">
              <h1 className="m-0 font-extrabold leading-[1.1] text-n83-white text-[clamp(4rem,6vw,7rem)] mb-[clamp(2rem,3vw,3rem)] uppercase tracking-tight">
                Crypto Trading with N83-FX
              </h1>
              <p className="m-0 font-normal leading-[1.4] text-white/70 text-[clamp(1.8rem,2.2vw,2.4rem)] max-w-[55rem]">
                Trade the future of finance — with the clarity, transparency,
                and discipline that this market deserves.
              </p>
            </div>
            ...
            <div className="flex items-center gap-[clamp(2rem,3vw,3rem)] flex-col lg:flex-row">
              <Link
                href="/account/open"
                className="cursor-pointer font-medium rounded-[3rem] items-center border whitespace-nowrap inline-flex justify-center transition-smooth text-[clamp(1.6rem,1.8vw,1.9rem)] py-[clamp(1.6rem,2vw,1.8rem)] px-[clamp(3.2rem,4vw,4rem)] text-n83-white bg-n83-black hover:-translate-y-[2px] hover:bg-n83-gray-900 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] w-full lg:w-auto max-w-[30rem]"
              >
                Open an Account Today
              </Link>
              <Link
                href="/platforms"
                className="cursor-pointer font-medium rounded-[3rem] items-center whitespace-nowrap inline-flex justify-center transition-smooth text-[clamp(1.6rem,1.8vw,1.9rem)] py-[clamp(1.6rem,2vw,1.8rem)] px-[clamp(3.2rem,4vw,4rem)] text-n83-white bg-white/15 hover:text-n83-white hover:-translate-y-[2px] hover:bg-white/20 w-full lg:w-auto max-w-[30rem]"
              >
                Download MT5
              </Link>
            </div>
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/crypto/crypto-hero.jpg"
                alt="Crypto trading platform showing Bitcoin and digital assets"
