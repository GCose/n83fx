      ...
      <div className="w-full max-w-container mx-auto px-container">
        ...
        <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-start">
          ...
          <div className="flex flex-col justify-center">
              ...
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div className="pt-[0.5rem]">
                    <h3 className="m-0 font-bold leading-[1.2] text-n83-white text-[clamp(1.8rem,2vw,2.2rem)] mb-[clamp(1rem,1.2vw,1.2rem)]">
                      {step.title}
                    </h3>
            ...
            <Link
              href="/account/open"
              className="cursor-pointer font-medium border-2 rounded-[3rem] items-center whitespace-nowrap inline-flex justify-center transition-smooth text-[clamp(1.6rem,1.8vw,1.9rem)] py-[clamp(1.6rem,2vw,1.8rem)] px-[clamp(3.2rem,4vw,4rem)] text-n83-white bg-n83-black hover:-translate-y-[2px] hover:bg-neon-primary/20hover:border-transparent w-full lg:w-auto max-w-[35rem]"
            >
              Get Started Today
            </Link>
            {/*==================== End of CTA ====================*/}
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/crypto/crypto-how.jpg"
