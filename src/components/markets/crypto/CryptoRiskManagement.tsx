        ...
        <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-start">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-[clamp(2.5rem,3vw,3rem)]">
              ...
              {/*==================== Risk Points ====================*/}
              <div className="space-y-[clamp(2rem,2vw,4rem)]">
                {riskPoints.map((point, index) => (
                  ...
                  >
                    <svg
                      className="w-[2.6rem] h-[2.6rem] text-n83-white mt-[0.6rem] flex-shrink-0 transition-transform duration-300 group-hover:scale-110"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/crypto/crypto-risk.jpg"
