        ...
        <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-start">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-[clamp(2.5rem,3vw,3rem)]">
              ...
              {/*==================== UAE Benefits ====================*/}
              <div className="grid gap-[clamp(2rem,2.5vw,4rem)] py-[clamp(2rem,3vw,3rem)] border-t border-b ">
                <div className="flex items-start gap-[1.5rem] group">
                  <svg
                    fill="currentColor"
                    viewBox="0 0 24 24"
                    className="w-[2rem] h-[2rem] text-n83-white mt-[0.6rem] flex-shrink-0"
                  >
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                  </svg>
                  <div>
                    <h4 className="m-0 font-bold leading-[1.2] text-n83-white text-[clamp(1.6rem,1.8vw,2rem)] mb-[0.5rem]">
          ...
          <div className="relative">
            ...
            {/*==================== VARA Highlight ====================*/}
            <div className="mt-[clamp(3rem,4vw,4rem)] p-[clamp(2.5rem,3vw,3rem)] bg-n83-white border-l border-r ">
