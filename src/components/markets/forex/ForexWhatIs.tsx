...
const ForexWhatIs = () => {
  return (
    <section className="relative bg-n83-black border-t border-b py-[clamp(8rem,12vw,12rem)]">
        ...
        <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-start">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-[clamp(2.5rem,3vw,3rem)]">
              <p className="m-0 font-normal leading-[1.5] text-n83-gray-50/70  text-[clamp(1.6rem,1.8vw,1.9rem)]">
