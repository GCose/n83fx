...
const FuturesDifference = () => {
  const differences = [
    "Honest conditions without gimmicks",
    "Calm, boutique platform designed for focus",
    "Transparent pricing and fair leverage",
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/futures/futures-difference.jpg"
                alt="Balanced and disciplined futures trading environment at N83-FX"
...
export default FuturesDifference;
