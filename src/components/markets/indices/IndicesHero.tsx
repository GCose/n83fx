          ...
          <div className="flex flex-col justify-center">
            <div className="mb-[clamp(3rem,4vw,4rem)]">
              <h1 className="m-0 font-extrabold leading-[1.1] text-n83-white text-[clamp(4rem,6vw,7rem)] mb-[clamp(2rem,3vw,3rem)] uppercase tracking-tight">
                Indices Trading with N83-FX
              </h1>
              <p className="m-0 font-normal leading-[1.4] text-white/70 text-[clamp(1.8rem,2.2vw,2.4rem)] max-w-[55rem]">
                Trade the performance of global markets through carefully
                selected stock indices — with clarity, transparency, and
                discipline.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/indices/indices-hero.jpg"
                alt="Indices trading platform showing global market benchmarks"
