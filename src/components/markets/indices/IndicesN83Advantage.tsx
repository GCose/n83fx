...
const IndicesN83Advantage = () => {
  const conditions = [
    "Access to major indices: S&P 500, Dow Jones, Nasdaq 100, FTSE 100, DAX 40, Nikkei 225, and more",
    "Tight spreads and competitive leverage",
    "Institutional-grade liquidity for dependable execution",
  ];

  const accountTypes = [
    {
      title: "Standard Account",
      description: "Entry-level access to index trading",
    },
    {
    ...
    {
      title: "Pro Account",
      description: "Professional-grade execution for active traders",
    },
    {
      title: "Islamic Account",
      description: "Swap-free, fully Sharia-compliant option",
    },
  ];
      ...
      <div className="w-full max-w-container mx-auto px-container">
        ...
        <div className="text-center mb-[clamp(6rem,8vw,8rem)]">
          ...
          <p className="m-0 font-normal leading-[1.5] max-w-[60rem] mx-auto text-n83-gray-600 text-[clamp(1.6rem,1.8vw,1.9rem)]">
            Three pillars that make indices trading at N83-FX different
          </p>
        </div>
            ...
            <div className="relative">
              <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
                <Image
                  width={800}
                  height={600}
                  src="/images/markets/indices/indices-advantage.jpg"
                  alt="Professional indices trading conditions and tight spreads"
          ...
          <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-center">
            ...
            <div className="relative">
              <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
                <Image
                  width={800}
                  height={600}
                  src="/images/markets/indices/indices-advantage-2.jpg"
                  alt="MetaTrader 5 platform optimized for indices trading"
                  className="w-full h-full object-cover transition-transform duration-[0.6s] min-h-[clamp(40rem,50vh,60rem)] lg:min-h-[clamp(35rem,45vh,50rem)] md:min-h-[clamp(30rem,40vh,45rem)] saturate-[0.8] contrast-[1.1] brightness-[0.95] group-hover:scale-[1.02]"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="m-0 font-normal leading-[1.5] text-n83-gray-600 text-[clamp(1.6rem,1.8vw,1.9rem)]">
                Trade indices on MetaTrader 5 (MT5), customized for clarity. Our
                layouts are simple, tools are purposeful, and execution is fast
                and reliable.
              </p>
            </div>
...
export default IndicesN83Advantage;
