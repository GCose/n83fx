        ...
        <div className="bg-neon-primary/15 rounded-[3rem] p-[clamp(4rem,6vw,6rem)] text-center">
          ...
          <div className="space-y-[clamp(2rem,3vw,3rem)] mb-[clamp(4rem,5vw,5rem)]">
            <p className="m-0 font-normal leading-[1.5] text-n83-white text-[clamp(1.8rem,2vw,2rem)] max-w-[80rem] mx-auto">
              Indices allow you to trade the movement of entire economies. At
              N83-FX, we give you the clarity, transparency, and tools to
              participate confidently.
            </p>

            <p className="m-0 font-normal leading-[1.5] text-n83-white/80 text-[clamp(1.6rem,1.8vw,1.9rem)] max-w-[70rem] mx-auto">
              Trade global indices with a platform built around calm, clarity,
              and respect.
            </p>
          </div>
...
export default IndicesStartJourney;
