...
const IndicesWhy = () => {
  const tradingReasons = [
    "Diversify instantly. A single index can represent dozens or hundreds of companies.",
    "Reflect economic health. Indices move with earnings seasons, central bank decisions, and global events.",
    "Provide opportunities. Indices often trend strongly during times of growth or volatility.",
    "Allow strategic trading. Whether you believe a market will rise or fall, indices let you express your view clearly.",
  ];
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-[clamp(2.5rem,3vw,3rem)]">
              <p className="m-0 font-normal leading-[1.5] text-n83-gray-600 text-[clamp(1.6rem,1.8vw,1.9rem)]">
                Indices are a popular choice for traders because they:
              </p>
              ...
              <div className="pt-[clamp(2rem,3vw,3rem)] border-t border-n83-black">
                <p className="m-0 font-medium leading-[1.5] text-n83-black text-[clamp(1.7rem,1.9vw,2rem)]">
                  Indices provide a clear way to trade market sentiment and
                  economic direction.
                </p>
              </div>
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/indices/indices-why.jpg"
                alt="Strategic indices trading opportunities and economic diversification"
