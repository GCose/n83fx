...
const MetalsWhyDifferent = () => {
  const differences = [
    "Honest trading conditions",
    "Calm, boutique environment",
    "Transparent pricing with no gimmicks",
    "Long-term trust at the center of everything",
  ];
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-[clamp(2.5rem,3vw,3rem)]">
              <p className="m-0 font-normal leading-[1.5] text-n83-gray-600 text-[clamp(1.6rem,1.8vw,1.9rem)]">
                Competitors often market gold as a quick-profit opportunity. We
              ...
              <div className="pt-[clamp(2rem,3vw,3rem)] border-t border-n83-black">
                <p className="m-0 font-medium leading-[1.5] text-n83-black text-[clamp(1.7rem,1.9vw,2rem)]">
                  We believe metals deserve the same respect and clarity as any
                  other market — without the hype.
                </p>
              </div>
              ...
              <div className="p-[clamp(2.5rem,3vw,3rem)] bg-n83-gray-50 border-l border-r border-n83-black">
                <p className="m-0 font-medium leading-[1.4] text-n83-black text-[clamp(1.8rem,2vw,2rem)]">
                  Every feature at N83-FX is designed to support thoughtful
                  trading decisions in metals markets.
                </p>
              </div>
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/metals/metals-difference.jpg"
                alt="Honest and transparent metals trading environment at N83-FX"
...
export default MetalsWhyDifferent;
