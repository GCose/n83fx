...
const MetalsN83Advantage = () => {
  const conditions = [
    "Access to gold, silver, platinum, palladium, copper, and more",
  ...
  const accountTypes = [
    {
      ...
      description: "Easy access to precious and industrial metals",
    },
    {
      title: "Advanced Account",
      description: "Lower spreads, more flexibility",
    },
    {
      title: "Pro Account",
      description: "Professional execution for active traders",
    },
    {
      title: "Islamic Account",
      description: "Swap-free, Sharia-compliant trading",
    },
  ];
      ...
      <div className="w-full max-w-container mx-auto px-container">
        ...
        <div className="text-center mb-[clamp(6rem,8vw,8rem)]">
          ...
          <p className="m-0 font-normal leading-[1.5] max-w-[60rem] mx-auto text-n83-gray-600 text-[clamp(1.6rem,1.8vw,1.9rem)]">
            Three pillars that make metals trading at N83-FX different
          </p>
        </div>
            ...
            <div className="relative">
              <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
                <Image
                  width={800}
                  height={600}
                  src="/images/markets/metals/metals-advantage.jpg"
                  alt="Professional metals trading conditions and tight spreads"
          ...
          <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-center">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="m-0 font-normal leading-[1.5] text-n83-gray-600 text-[clamp(1.6rem,1.8vw,1.9rem)]">
                Metals are traded on MetaTrader 5 (MT5), customized at N83-FX to
                emphasize clarity. Every chart and tool is simplified for
                decision-making.
              </p>
            </div>
...
export default MetalsN83Advantage;
