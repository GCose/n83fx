...
const MetalsProcess = () => {
  const steps = [
    ...
    },
    {
      ...
      title: "Fund Safely",
      description:
        "Deposit securely, with funds protected in segregated accounts.",
    },
    {
      number: "03",
      title: "Download MT5",
      description: "Trade metals from desktop, web, or mobile.",
    },
    {
      number: "04",
      title: "Select Your Market",
      description:
        "Choose between gold, silver, platinum, palladium, or base metals.",
    },
    {
      number: "05",
      title: "Trade with Confidence",
      description:
        "Use our calm, transparent tools to execute trades clearly and securely.",
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-center">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="m-0 font-extrabold leading-[1.2] text-n83-white text-[clamp(3rem,4vw,4.5rem)] mb-[clamp(3rem,4vw,4rem)] uppercase tracking-tight">
              How to Start Trading Metals with N83-FX
            </h2>
            ...
            <div className="space-y-[clamp(2.5rem,3vw,3rem)] mb-[clamp(4rem,5vw,5rem)]">
              <p className="m-0 font-normal leading-[1.5] text-white/70 text-[clamp(1.6rem,1.8vw,1.9rem)]">
                Getting started with metals trading at N83-FX is
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/metals/metals-process.jpg"
                alt="Step-by-step metals trading account setup process"
