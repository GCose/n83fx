...
const MetalsRisk = () => {
  const riskPrinciples = [
    ...
    "Avoid over-leverage",
    "Diversify between precious and industrial metals",
    "Balance metals with other asset classes",
  ];
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/metals/metals-risk.jpg"
                alt="Risk management tools and responsible metals trading strategies"
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-[clamp(2.5rem,3vw,3rem)]">
              <p className="m-0 font-normal leading-[1.5] text-n83-gray-600 text-[clamp(1.6rem,1.8vw,1.9rem)]">
                Metals can be volatile, especially during geopolitical or
                economic shifts. At N83-FX, we encourage traders to:
              </p>
              ...
              <div className="pt-[clamp(2rem,3vw,3rem)] border-t border-n83-black">
                <p className="m-0 font-medium leading-[1.5] text-n83-black text-[clamp(1.7rem,1.9vw,2rem)]">
                  We believe that stating risks clearly is a form of respect.
                </p>
              </div>
