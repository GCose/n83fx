...
const MetalsWhy = () => {
  const tradingReasons = [
    "Act as safe havens. Gold and silver often rise when currencies or stocks are unstable.",
    "Hedge inflation. Precious metals protect against the declining value of money.",
    "Provide diversification. Metals add balance to portfolios that include Forex, stocks, or crypto.",
    "Reflect global demand. Industrial metals like copper move with construction, technology, and energy transitions.",
  ];
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-[clamp(2.5rem,3vw,3rem)]">
              <p className="m-0 font-normal leading-[1.5] text-n83-gray-600 text-[clamp(1.6rem,1.8vw,1.9rem)]">
                Metals are attractive because they:
              </p>
              ...
              <div className="pt-[clamp(2rem,3vw,3rem)] border-t border-n83-black">
                <p className="m-0 font-medium leading-[1.5] text-n83-black text-[clamp(1.7rem,1.9vw,2rem)]">
                  Whether for hedging or speculation, metals provide timeless
          ...
          <div className="relative">
            <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
              <Image
                width={800}
                height={600}
                src="/images/markets/metals/metals-why.jpg"
                alt="Safe haven metals and inflation hedging opportunities"
