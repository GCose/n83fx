...
const StocksN83Advantage = () => {
  const conditions = [
    "Access to leading global stocks (U.S., European, and beyond)",
    "Tight spreads and competitive leverage",
    "Real-time data and execution with institutional-grade liquidity",
  ];

  const accountTypes = [
    {
      title: "Standard Account",
      description: "Straightforward access for new traders",
    },
    {
    ...
    },
    {
      title: "Pro Account",
      description:
        "Professional-grade execution and pricing for active traders",
    },
    {
      title: "Islamic Account",
      description: "Swap-free, fully Sharia-compliant options",
    },
  ];
      ...
      <div className="w-full max-w-container mx-auto px-container">
        ...
        <div className="mb-[clamp(8rem,12vw,10rem)] border-b">
          ...
          <p className="font-body text-[clamp(1.8rem,2.5vw,2.4rem)] font-500 text-text-secondary leading-[1.4] text-right pb-6">
            Three pillars that make stocks trading at N83-FX different
          </p>
        </div>
            ...
            <div className="relative">
              <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
                <Image
                  width={800}
                  height={600}
                  src="/images/markets/stocks/stocks-advantage.jpg"
                  alt="Professional stocks trading conditions and tight spreads"
          ...
          <div className="grid lg:grid-cols-2 gap-[clamp(6rem,8vw,8rem)] items-center">
            ...
            <div className="relative">
              <div className="overflow-hidden relative rounded-[2.4rem] md:rounded-[1.6rem] bg-n83-black group">
                <Image
                  width={800}
                  height={600}
                  src="/images/markets/stocks/stocks-advantage-2.jpg"
                  alt="MetaTrader 5 platform optimized for stocks trading"
                  className="w-full h-full object-cover transition-transform duration-[0.6s] min-h-[clamp(40rem,50vh,60rem)] lg:min-h-[clamp(35rem,45vh,50rem)] md:min-h-[clamp(30rem,40vh,45rem)] saturate-[0.8] contrast-[1.1] brightness-[0.95] group-hover:scale-[1.02]"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="m-0 font-normal leading-[1.5] text-white/70 text-[clamp(1.6rem,1.8vw,1.9rem)]">
                Trade stocks through MetaTrader 5 (MT5), customized at N83-FX
                for clarity. Every chart, every order, every function is
...
export default StocksN83Advantage;
